    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (correct) {
            ...
            try {              
                ...
                String query = "select max(account_number) from accounts";
                ResultSet rs = st.executeQuery(query);
                if(rs.next()){
                    String val = rs.getString(1);
                    if(val != null){
                        Anumber = Integer.toString(Integer.parseInt(val) + 1);
                    }
                    
                }
               
                ps = conn.prepareStatement("INSERT INTO `accounts` (`account_number`, `full_name`, `email`, `phone_number`, `password`, `gender`, `balance`) VALUES (?, ?, ?, ?, ?, ?, ?);");
            ...
            String ss = "Your account has succefuly created\n"+ 
                        "---------------------------------------------\n"+
                        "Name:-                         "+Name+
                        "\nEmail:-                          "+Email+
                        "\nPhone Number:-         "+Phone+
...
/*
//                 String ss = "insert into accounts values('\"+Anumber+\"', '\"+Name+\"', '\"+Email+\"', '\"+Phone+\"', '\"+Password+\"', '\"+Balance+\"')" ;
////                String sql = "Select * from accounts";
//                  Statement st;
//                String sss = "insert into accounts values(" + " 'Anumber' ," + "'Name' ," + "'Email'," +  "'Phone', " + "'Password'," + "'Balance');" ;
//                System.out.println(sss);
//                String ne = "INSERT INTO `accounts` (`account_number`, `full_name`, `email`, `phone_number`, `password`, `gender`, `balance`) VALUES ('123456', 'sdfs', 'sdfsd', 'sdfsdfssdf', 'sdfsdfsdfsd', 'm', '532');";

//System.out.println(sql+"geeks");
*/